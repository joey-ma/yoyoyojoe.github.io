...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // bgm setup
  let musicPlayer = getMusicPlayer();
  ...
  body.addEventListener('keydown', (e) => {
    ...
    switch (e.code) {
      ...
      //     paused.status = true;
      //     head.SPEED = 1000000;
      //     console.log('paused: ', paused.status, 'head.SPEED (current)', head.SPEED, 'prior speed:', paused.speed, 'current direction:', head.currentDirection);
      //   } else {
      //     paused.status = false;
